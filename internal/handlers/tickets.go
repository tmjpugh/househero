	...
	if h.mqtt != nil {
		...
		if ctxErr := h.db.QueryRow(
			...
			h.mqtt.Publish(mqttservice.TopicCommentAdded, mqttservice.CommentEvent{
				...
				TicketRequester:       t.Requester,
				TicketRoom:            t.Room,
				TicketDescription:     t.Description,
				TicketInventoryItemID: t.InventoryItemID,
				TicketInventoryItem:   t.InventoryItem,
				TicketEstimatedCost:   t.EstimatedCost,
				TicketCloser:          t.Closer,
				TicketCreatedAt:       t.CreatedAt,
				TicketUpdatedAt:       t.UpdatedAt,
				TicketClosedAt:        t.ClosedAt,
			})
		}
	}
